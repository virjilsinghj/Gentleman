...
<meta name="description" content="This is for account recovery once a customers forgets his password">
            ...
            <div class="vj-container vj-white vj-padding-32">
                <form action="forget.php" method="POST">
                    ...
                    <p>Email:<input class="vj-input vj-border" type="email" placeholder="Email" name="Email" required
                            style="width:66%"></p>
                    <p>Phone Number:<input class="vj-input vj-border" type="number" placeholder="Phone Number"
                            name="Phone_Number" required style="width:60%"></p>
                   ...
                   $query="SELECT * FROM signin where Email='$Email' and Phone_Number='$Phone_Number';";
